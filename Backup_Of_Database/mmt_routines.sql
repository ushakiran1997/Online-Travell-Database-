...
--
-- Temporary view structure for view `hcollection`
--

DROP TABLE IF EXISTS `hcollection`;
/*!50001 DROP VIEW IF EXISTS `hcollection`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `hcollection` AS SELECT 
...
--
-- Final view structure for view `hcollection`
--
...
/*!50001 VIEW `hcollection` AS select `hcollection1`.`Destination_Type` AS `Destination_Type`,`hcollection2`.`Country_Code` AS `Country_Code`,`hcollection2`.`Peak_Time` AS `Peak_Time`,`hcollection2`.`No_Of_Activity` AS `No_Of_Activity`,`hcollection3`.`Things_To_See` AS `Things_To_See` from ((`hcollection1` join `hcollection2` on((`hcollection1`.`Destination_ID` = `hcollection2`.`Destination_ID`))) join `hcollection3` on((`hcollection1`.`Destination_ID` = `hcollection3`.`Destination_ID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Dumping events for database 'mmt'
--

--
-- Dumping routines for database 'mmt'
--
/*!50003 DROP PROCEDURE IF EXISTS `BUS_Train` */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `hotel_materialised_refresh` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `MainData` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `matrializedrevenuerefresh` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `profitNLoss` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
